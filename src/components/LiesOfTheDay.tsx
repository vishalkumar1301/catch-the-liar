...
export default function LiesOfTheDay() {
    ...
    return (
        <div className="max-w-8xl mx-auto">
            <div className="text-lg md:text-2xl lg:text-3xl xl:text-4xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent my-4 md:my-8">
                Lies of the Day
            </div>
